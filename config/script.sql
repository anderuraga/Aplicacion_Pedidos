...
ALTER TABLE `pedidos` ADD `id_transaccion` INT NULL DEFAULT NULL AFTER `baja`;
ALTER TABLE `pedidos` ADD CONSTRAINT `pedido_transaccion` FOREIGN KEY (`id_transaccion`) REFERENCES `transacciones`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
