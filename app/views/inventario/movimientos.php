        ...
        <div class="widget-content widget-content-area p-3">
            ...
            <form id="editarMovimiento" class="mt-0 formulario"
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <div class="form-check form-check-primary form-check-inline">
                            <input class="form-check-input" type="radio" name="tipo" id="tipoEdit" value="Entrada"
                                required <?= $movimiento->cantidad > 0 ? 'checked' : '' ?>>
                            <label class="form-check-label" for="tipo">
                                Entrada
                            </label>
                        </div>
                        <div class="form-check form-check-primary form-check-inline">
                            <input class="form-check-input" type="radio" name="tipo" id="tipoEdit" value="Salida"
                                required <?= $movimiento->cantidad < 0 ? 'checked' : '' ?>>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <?php if ($usuario->tipo == ADMIN && $movimiento->id != 0): ?>
...
<?php
$nombreBorrar = "Movimiento";
$idborrar = $movimiento->id;
