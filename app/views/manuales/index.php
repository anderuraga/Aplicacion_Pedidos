...
<div id="tableSimple" class="col-lg-12 col-12 layout-spacing">
    <div class="statbox widget box box-shadow">
        <div class="widget-content widget-content-area">
            <h1 class="mt-2 ms-2">Manuales</h1>

            <ul class="list-group p-4">
                <li class="list-group-item"><a href="mailto:admincentral@elorrieta-errekamari.com?Subject=Duda%20sobre%20Hoja%20de%20Pedidos"><svg fill="#000000" width="50px" height="50px"
                            viewBox="0 0 24 24" id="email" data-name="Flat Line" xmlns="http://www.w3.org/2000/svg"
                        ...
                        </svg>Escribe un email a adminstración</a></li>
                <li class="list-group-item"><a
                        href="https://docs.google.com/document/d/14gx4Ji4YM-MxQMr6ei3mMwYYZ37fUSNPJGH32cwDNDI/edit?usp=sharing"
                        target="_blank"><svg width="64px" height="64px" viewBox="0 0 9.2 9.2"
                            style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd"
                            version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink"
                            xmlns:xodm="http://www.corel.com/coreldraw/odm/2003" fill="#000000">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <defs>
                                ...
                                <g id="Layer_x0020_1">
                                    <rect class="fil0" height="9.2" width="9.2"></rect>
                                    <path class="fil1"
                                    ...
                                    <polygon class="fil2" points="4.97,2.78 4.97,3.86 6.06,3.86 "></polygon>
                                    <path class="fil1"
                                        d="M5.12 3.14l0 0.57 0.58 0 -0.58 -0.57zm-0.3 0.72l0 -1.08c0,-0.04 0.02,-0.08 0.05,-0.11 0.05,-0.06 0.15,-0.06 0.21,0l1.08 1.09c0.03,0.02 0.05,0.06 0.05,0.1 0,0.09 -0.07,0.15 -0.15,0.15l-1.09 0c-0.08,0 -0.15,-0.06 -0.15,-0.15z">
                                    </path>
                                    <path class="fil3"
                                        d="M3.95 4.95c-0.09,0 -0.15,-0.07 -0.15,-0.15 0,-0.08 0.06,-0.15 0.15,-0.15l1.3 0c0.09,0 0.15,0.07 0.15,0.15 0,0.08 -0.06,0.15 -0.15,0.15l-1.3 0z">
                                    </path>
                                    <path class="fil3"
                                        d="M3.95 5.7c-0.09,0 -0.15,-0.06 -0.15,-0.15 0,-0.08 0.06,-0.14 0.15,-0.14l0.74 0c0.09,0 0.15,0.06 0.15,0.14 0,0.09 -0.06,0.15 -0.15,0.15l-0.74 0z">
                                    </path>
                                </g>
                            </g>
                ...
                <li class="list-group-item"><a href="#" target="_blank"><svg width="50px" height="50px"
                        ...
                        </svg>Crear Hoja de Pedidos > 1.000€</a></li>
            </ul>
