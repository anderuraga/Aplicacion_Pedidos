...
<body class="layout-boxed">
    ...
    <div class="main-container " id="container">
        ...
        <div id="content" class="main-content">
                            ...
                            <div class="statbox widget box box-shadow">
                                <div class="widget-content widget-content-area">
                                    ...
                                    <button type="button" class="btn btn-primary mb-2 ms-2 me-4" data-bs-toggle="modal"
                                        data-bs-target="#nuevoEstadoModal">Nuevo Estado</button>
                                    <table id="estados" class="table table-striped dt-table-hover" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>id</th>
                                                <th>Nombre</th>
            ...
            <!--  END CONTENT AREA  -->
            <!-- Modal Nuevo Estado -->
            <div class="modal fade inputForm-modal" id="nuevoEstadoModal" tabindex="-1" role="dialog"
                aria-labelledby="nuevoEstadoModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">

                        <div class="modal-header" id="nuevoEstadoModalLabel">
                            <h5 class="modal-title">Crear nuevo Estado
                            </h5>
                        ...
                        <div class="modal-body">
                            <form id="newEstado" class="mt-0">
                                <input type="text" class="form-control" placeholder="Nombre" aria-label="nombre"
                                    name="nombre" id="nombre" required>
                                <h5>Estado anterior:</h5>
                                <select class="form-control" name="departamento" id="departamento" required>
                                    <option>Borrador</option>
                                    <option>Enviado secretaría</option>
                                    <option>Correcciones necesarias</option>
                                    <option>Enviado Proveedor</option>
                                </select>
                            </form>
        ...
        <!-- Modal Editar Estado -->
        <div class="modal fade inputForm-modal" id="editarEstadoModal" tabindex="-1" role="dialog"
            aria-labelledby="editarEstadoModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">

                    <div class="modal-header" id="editarEstadoModalLabel">
                        <h5 class="modal-title">Editar Estado
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true">
                            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="borrarEstado()"
    ...
    <script>
        ...
        $('#editEstado').on('submit', function (e) {
            e.preventDefault();
        })
        ...
        $('#newEstado').on('submit', function (e) {
            e.preventDefault();
        })

        $('#nuevoEstadoModal').on('hidden.bs.modal', function () {
