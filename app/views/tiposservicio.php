...
<body class="layout-boxed">
    ...
    <div class="main-container " id="container">
        ...
        <div id="content" class="main-content">
                            ...
                            <div class="statbox widget box box-shadow">
                                <div class="widget-content widget-content-area">
                                    ...
                                    <button type="button" class="btn btn-primary mb-2 ms-2 me-4" data-bs-toggle="modal"
                                        data-bs-target="#tipoServicioModal">Nuevo Tipo de Servicio</button>
                                    <table id="tiposservicio" class="table table-striped dt-table-hover" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>id</th>
                                                <th>Nombre</th>
            ...
            <!--  END CONTENT AREA  -->
            <!-- Modal Nuevo Usuario -->
            <div class="modal fade inputForm-modal" id="tipoServicioModal" tabindex="-1" role="dialog"
                aria-labelledby="tipoServicioModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">

                        <div class="modal-header" id="tipoServicioModalLabel">
                            <h5 class="modal-title">Crear nuevo Tipo de Servicio
                            </h5>
                        ...
                        <div class="modal-body">
                            <form id="nuevoTipoServicio" class="mt-0">
        ...
        <div class="modal fade inputForm-modal" id="editarTipoServicioModal" tabindex="-1" role="dialog"
            aria-labelledby="editarTipoServicioModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">

                    <div class="modal-header" id="editarTipoServicioModalLabel">
                        <h5 class="modal-title">Editar Tipo de Servicio
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true">
                            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    ...
                    <div class="modal-body">
                        <form id="editarTipoServicio" class="mt-0">
    ...
    <script>
        ...
        function editar(id, nombre, active) {
            $('#editarTipoServicioModal').modal('show');
        }

        $('#nuevoTipoServicio').on('submit', function (e) {
            e.preventDefault();
        })

        $('#tipoServicioModal').on('hidden.bs.modal', function () {
