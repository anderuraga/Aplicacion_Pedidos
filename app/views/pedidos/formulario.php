            ...
            <div class="row mb-2">
                <div class="col-12 ">
                    ...
                    <?php switch ($pedido->estado->id) {
                        ...
                        <a class="btn btn-warning" href="<?= BASE_URL ?>Incidencias/vereditar?id=0&pedido=<?= $pedido->id ?>">Nueva Incidencia</a>                            
                        
                        <?php if ($usuario->tipo == ADMIN): ?>
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#borrarModal">Eliminar</button>                            
                        <?php endif; ?>
                            ...
                            <div class="mb-2">
                                ...
                                <?php if ($pres && $pres->documento): ?>
                                    <a href="<?= BASE_URL ?>public/uploads/presupuestos/<?= $pedido->id ?>/<?= $pres->documento ?>"
                                        target="_blank" class="ms-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg> Ver documento</a>
                                <?php endif; ?>
                    ...
                    <form class="mb-2 formulario" id="subirFactura" method="post"
                        ...
                        <?php if (isset($pedido->factura) && $pedido->factura->id != 0): ?>
                            <a href="<?= BASE_URL ?>public/uploads/presupuestos/<?= $pedido->id ?>/<?= $pedido->factura->documento ?>"
                                target="_blank" class="ms-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg> Ver factura </a>
                        <?php endif; ?>
                        <div class="mb-2">
