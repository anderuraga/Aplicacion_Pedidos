...
<div id="tableSimple" class="col-lg-12 col-12 layout-spacing">
    <div class="statbox widget box box-shadow">
        <div class="widget-content widget-content-area p-3">
            ...
            <form id="editarAreaGasto" class="mt-0 formulario" action="<?= BASE_URL ?>AreasGastos/vereditar?id=<?= $areaGasto->id ?>"
                method="post">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header" id="borrarModalLabel">
                <h5 class="modal-title">Borrar Area de Gastos
                </h5>
            ...
            <div class="modal-body">
                <form id="borrarForm" class="mt-0" method="post">
                    <input type="hidden" name="id" value="<?= $areaGasto->id ?>">
