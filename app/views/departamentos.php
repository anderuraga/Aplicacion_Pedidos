...
<body class="layout-boxed">
    ...
    <div class="main-container " id="container">
        ...
        <div id="content" class="main-content">
                            ...
                            <div class="statbox widget box box-shadow">
                                <div class="widget-content widget-content-area">
                                    ...
                                    <button type="button" class="btn btn-primary mb-2 ms-2 me-4" data-bs-toggle="modal"
                                        data-bs-target="#nuevoDepartamentoModal">Nuevo departamento</button>
                                    <table id="departamentos" class="table table-striped dt-table-hover"
                                        style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>id</th>
            ...
            <!--  END CONTENT AREA  -->
            <!-- Modal Nuevo Usuario -->
            <div class="modal fade inputForm-modal" id="nuevoDepartamentoModal" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-header" id="nuevoDepartamentoModalLabel">
                            <h5 class="modal-title">Crear nuevo Departamento
                            </h5>
                        ...
                        <div class="modal-body">
                            <form id="nuevoDepartamento" class="mt-0">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header" id="editarDepartamentoModalLabel">
                        <h5 class="modal-title">Editar Deparetamento
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true">
                            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
    ...
    <script>
        ...
        $('#nuevoDepartamentoModal').on('hidden.bs.modal', function () {
                ...
                { data: 'nombre' },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <button type="button" data-id="${row.id}" data-nombre="${row.nombre}" onclick="editar(this)" class="btn btn-primary">Editar</button>
                        </div>
                        `;
                    }
                }
