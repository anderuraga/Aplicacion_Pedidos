...
<body class="layout-boxed">
    ...
    <div class="main-container " id="container">
        ...
        <div id="content" class="main-content">
                            ...
                            <div class="statbox widget box box-shadow">
                                <div class="widget-content widget-content-area">
                                    ...
                                    <button type="button" class="btn btn-primary mb-2 ms-2 me-4" data-bs-toggle="modal"
                                        data-bs-target="#nuevoIngresoModal">Nuevo Ingreso</button>

                                    <table id="ingresos" class="table table-striped dt-table-hover" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>id</th>
                                                <th>Fecha</th>
            ...
            <!--  END CONTENT AREA  -->
            <!-- Modal Nuevo Usuario -->
            <div class="modal fade inputForm-modal" id="nuevoIngresoModal" tabindex="-1" role="dialog"
                aria-labelledby="nuevoIngresoModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">

                        <div class="modal-header" id="nuevoIngresoModalLabel">
                            <h5 class="modal-title">Nuevo Ingreso
                            </h5>
                        ...
                        <div class="modal-body">
                            <form id="nuevoIngreso" class="mt-0">
                                ...
                                <input type="text" class="form-control mb-2" placeholder="Descripción"
                                    aria-label="nombre" name="descripcion" id="descripcion" required>
                                <h5>Area de gasto:</h5>
                                <select class="form-control mb-2" name="areagasto" id="areagasto" required>
                                    <option value="" disabled selected>Selecciona un area de gastos</option>
                        ...
                        <div class="modal-footer">
                            ...
                            <button id="submitButton" type="submit" form="nuevoIngreso"
    ...
    <script>
        ...
        $('#nuevoIngreso').on('submit', function (e) {
            e.preventDefault();
        ...
        $('#nuevoIngresoModal').on('hidden.bs.modal', function () {
